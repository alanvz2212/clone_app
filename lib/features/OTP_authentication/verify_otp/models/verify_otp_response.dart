...
class UserData {
  ...
  factory UserData.fromJson(Map<String, dynamic> json) {
    ...
    print('JSON: $json');
    print(
      'stateId type: ${json['stateId'].runtimeType}, value: ${json['stateId']}',
    );
    print('type type: ${json['type'].runtimeType}, value: ${json['type']}');
    print(
      'countryId type: ${json['countryId'].runtimeType}, value: ${json['countryId']}',
    );
    print(
      'districtId type: ${json['districtId'].runtimeType}, value: ${json['districtId']}',
    );
    print(
      'numberOfCreditDays type: ${json['numberOfCreditDays'].runtimeType}, value: ${json['numberOfCreditDays']}',
    );
    print(
      'numberOfBlockDays type: ${json['numberOfBlockDays'].runtimeType}, value: ${json['numberOfBlockDays']}',
    );
    print(
      'executiveId type: ${json['executiveId'].runtimeType}, value: ${json['executiveId']}',
    );
    print(
      'referenceId type: ${json['referenceId'].runtimeType}, value: ${json['referenceId']}',
    );
